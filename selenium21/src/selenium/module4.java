...
public class module4 
{
		...
		Select dropdown=new 
				Select(driver.findElement(By.xpath("//*[@name=\"indiGoOneWaySearch.PassengerCounts[0].Count\"]")));
				dropdown.selectByIndex(2);
				Select dropdown1 =new 
				Select(driver.findElement(By.xpath("//*[@name=\"indiGoOneWaySearch.PassengerCounts[1].Count\"]")));
